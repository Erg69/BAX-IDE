...
Here is the base script to build BAX:
...
- Linux: https://github.com/BAX/bax/blob/master/.github/workflows/stable-linux.yml
- macOS: https://github.com/BAX/bax/blob/master/.github/workflows/stable-macos.yml
- Windows: https://github.com/BAX/bax/blob/master/.github/workflows/stable-windows.yml
...
- open `vscode` directory in a new **BAX**'s window
- fix all the `*.rej` files
- run `npm run watch`
- run `./script/code.sh` until everything is ok
