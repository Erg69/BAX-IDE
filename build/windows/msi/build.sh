...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="BAX - Insiders"
  PRODUCT_CODE="BAXInsiders"
...
if [[ -z "${1}" ]]; then
	OUTPUT_BASE_FILENAME="BAX-${VSCODE_ARCH}-${RELEASE_VERSION}"
else
	OUTPUT_BASE_FILENAME="BAX-${VSCODE_ARCH}-${1}-${RELEASE_VERSION}"
fi
